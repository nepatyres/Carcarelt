...
function Footer() {
    return (
        <div className="bg-black h-auto" id='scrollToFooter'>
            <div className="flex-col flex items-center w-[80%] m-auto lg:flex-row lg:justify-between">
                <div className="w-full lg:w-[50%]">
                    <div className="font-ubuntuL text-white w-full">
                        <span className="flex justify-center mt-[50px] mb-2.5 font-gruppo font-semibold text-white/90 tracking-wider text-[30px]">FIND US</span>

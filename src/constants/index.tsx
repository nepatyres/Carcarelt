//FOR NAVBAR SECTION
export const navbar = [{ name: 'Our services', scrollT: 'scrollToServices' }, { name: 'Prices', scrollT: 'scrollToPrices' }, { name: 'About us', scrollT: 'scrollToAboutUs' }];
...
export const services = [
    ...
    {
        front: 'Paint Protection Film (PPF)',
        back: "It is a clear, durable, self-healing film that is applied to the surface of a vehicle to protect the paint from rock chips, bug splatter, and other environmental contaminants.",
        url: '/images/ppf.png'
    },
    {
        front: 'Wheel Repair',
...
export const prices = [
    {
        description: ['Vacuuming', 'Dusting', 'Dry Brushing', 'Shampooing', 'Steam Cleaning', 'Spot Cleaning', 'Surface Conditioning', 'Deodorizing'],
        0: { name: 'Dry Interior Cleaning', price: '€125', check: 3 },
        1: { name: 'Wet Interior Cleaning', price: '€170', check: 6 },
        2: { name: 'Trifecta Interior Cleaning', price: '€220', check: 8 }
    },
    {
        description: ['Wash and Decontamination', 'Sealant or Ceramic Coating', 'Single-Stage Polishing', 'Paint Enhancement', 'Two-Stage Polishing', 'Comprehensive Cleaning', 'Three-Stage Paint Correction'],
        0: { name: '1 Stage Polishing', price: '€120', check: 3 },
        1: { name: '2 Stage Polishing', price: '€180', check: 5 },
        2: { name: '3 Stage Polishing', price: '€300', check: 8 }
    },
    {
        description: ['Front bumper', 'Partial Hood', 'Side Mirrors', 'Full Hood', 'Fenders (Partial)', 'Headlights and Fog Lights', 'Full Vehicle Coverage'],
        0: { name: 'Essential Protection Package', price: '€300', check: 3 },
        1: { name: 'Advanced Shield Package', price: '€600', check: 6 },
        2: { name: 'Ultimate Defense Package', price: '€2500', check: 8 }
    },
    {
        description: ['Alloy Wheel Refinishing', 'Wheel Inspection', 'Balancing', 'Color Matching'],
        0: { name: '', price: '', check: 0 },
        1: { name: 'Wheel Repair Package', price: '€100', check: 4 },
        2: { name: '', price: '', check: 0 }
    },
]

export const lists = ['Interior Detailing', 'Car Polishing', 'PPF Protection', 'Wheel Repair'];
...
export const aboutUs = [
    {
        span: 'Innovation and Passion',
        text: 'Innovative techniques and a love for automotive excellence drive us to elevate your vehicle care.',
        svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-[80px] h-[70px] fill-white/70 pt-[5px]">
    ...
    {
        span: 'Customer-Centric Care',
        text: 'Personalized solutions, transparent service, and exceeding expectations are our commitment to you.',
        svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-[80px] h-[70px] fill-white/70 pt-[5px]">
    ...
    {
        span: 'Precision Driven',
        text: 'Meticulous craftsmanship for automotive excellence. Your satisfaction is our success.',
        svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-[80px] h-[70px] fill-white/70 pt-[5px]">
            <path d="M24 0C10.767 0 0 10.767 0 24s10.767 24 24 24 24-10.767 24-24S37.233 0 24 0zm0 47C11.318 47 1 36.682 1 24S11.318 1 24 1s23 10.318 23 23-10.318 23-23 23z" />
...
//FOR FOOTER SECTION
export const address = 'Lypkių g. 274, 95112 Klaipėda';
export const schedule = 'I-V 10:00-19:00, VI-VII Closed';